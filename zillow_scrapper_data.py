...
HEADER = {
    "Accept-Language": "ar-DZ,ar;q=0.9,en-US;q=0.8,en;q=0.7,fr-DZ;q=0.6,fr;q=0.5",
...
class Scrapper:
    ...
    def get_data(self):
        ...
        links = [site.get(key="href") if "https://www.zillow.com/" in site else "https://www.zillow.com/" + site.get(
